...
\begin{itemize}
	\item A system (such as the one given in exercise 2.b) which diverges to $\pm \infty$ as the number of cycles increases is called \emph{unstable}.
	\begin{itemize}
		\item Relates to a concept known as \emph{resonant frequencies}.
	\end{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item $N$ is called the system's order.
			\item The $x(n-k)$ terms are the system's inputs.
			\item The $y(nik)$ terms are called the system's feedback.
			\item Note that the lower bound for the sums of the $y(n-k)$ terms is 1.
