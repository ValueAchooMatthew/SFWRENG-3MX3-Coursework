...
\title{SFWRENG 3MX3 2025 Midterm Solutions}
...
\fancyhead[R]{SFWRENG 3MX3 2025 Midterm Solutions}
...
\begin{problem}
	Give the difference equation of a minimum order causal filter that filters the discrete frequencies $\pi$ and $\frac{\pi}{2}$ and has a gain of 1 at DC. Derive the frequency response and corresponding difference equation of such a filter.
\end{problem}

\begin{solution}
	\begin{steps}
		\item Find a prototype filter $\tilde{H}(\omega)$.
	\end{steps}
	...
	\begin{align*}
		\tilde{H}(\omega) &= (e^{-i\omega} - e^{-i\pi})(e^{-i\omega} - e^{-\frac{\pi}{2}i})(e^{-i\omega} - e^{\frac{\pi}{2}}) \\
		&= (e^{-i\omega} + 1)(e^{-i\omega} - i)(e^{-i\omega} + i) \\
	\end{align*}

	Note here that to ensure conjugate complex symmetry at $\frac{\pi}{2}$, we had to include both $\frac{\pi}{2}$ and $\frac{-\pi}{2}$ as zeros of our prototpe filter.

	Evaluating for $\omega = 0$, which is the DC, we can see the gain of our filter is:

	\begin{align*}
		|\tilde{H}(0)| &= |(1 + 1)(1 - i)(1 + i)| \\
		&= 2(1 - i^2) \\
		&= 2(1 - (-1)) \\
		&= 4 \\
	\end{align*}
	...
	\begin{align*}
		H(\omega) &= \frac{1}{4}(e^{-i\omega} + 1)(e^{-i\omega} - i)(e^{-i\omega} + i) \\
		&= \frac{1}{4}(e^{-i\omega} + 1)(e^{-2i\omega} + ie^{-i\omega} - ie^{-i\omega} + 1) \\
		&= \frac{1}{4}(e^{-i\omega} + 1)(e^{-2i\omega} + 1) \\
		&= \frac{1}{4}(e^{-3i\omega} + e^{-2i\omega} + e^{-i\omega} + 1) \\
	\end{align*}

	\begin{steps}
		\item Find the filter's difference equation.
	\end{steps}

	Using $y(n) = H(\omega)e^{in\omega}$ when $x(n) = e^{in\omega}$, we find:
	
	\begin{align*}
		H(\omega) &= \frac{1}{4}(e^{-3i\omega} + e^{-2i\omega} + e^{-i\omega} + 1) \\
		H(\omega)e^{in\omega} &= \frac{e^{in\omega}}{4}(e^{-3i\omega} + e^{-2i\omega} + e^{-i\omega} + 1) \\
		H(\omega)e^{in\omega} &= \frac{1}{4}(e^{-3i\omega}e^{in\omega} + e^{-2i\omega}e^{in\omega} + e^{-i\omega}e^{in\omega} + e^{in\omega}) \\
		H(\omega)e^{in\omega} &= \frac{1}{4}(e^{-3i\omega(n - 3)} + e^{-2i\omega(n - 2)} + e^{-i\omega(n - 1)} + e^{in\omega}) \\
		y(n) &= \frac{1}{4}(x(n - 3) + x(n - 2) + x(n - 1) + x(n))
	\end{align*}
\end{solution}
...
\begin{problem}
	...
	\begin{gather*}
		A = \begin{pmatrix} 0 & 1 \\ 1 & 0 \end{pmatrix}, \, B = \begin{pmatrix} 1 \\ 0 \end{pmatrix}, \, C = \begin{pmatrix} 1 & 1 \end{pmatrix}, \, D = \begin{pmatrix} 0 \end{pmatrix} \\
	\end{gather*}
...
\begin{solution}
	...
	\begin{align*}
		&\underline{S(n)} &&\underline{y(n)} \\\\
		&S(0) = 0 &&y(0) = \begin{pmatrix} 1 & 1\end{pmatrix}(0) = 0 \\
		&S(1) = \begin{pmatrix} 0 & 1 \\ 1 & 0 \end{pmatrix}S(0) + \begin{pmatrix} 1 \\ 0 \end{pmatrix}x(0) = \begin{pmatrix} 1 \\ 0 \end{pmatrix} &&y(1) \begin{pmatrix} 1 & 1 \end{pmatrix}\begin{pmatrix} 1 \\ 0 \end{pmatrix} = 1 \\
		&S(2) = \begin{pmatrix} 0 & 1 \\ 1 & 0 \end{pmatrix}S(1) + \begin{pmatrix} 1 \\ 0 \end{pmatrix}x(1) = \begin{pmatrix} 0 \\ 1 \end{pmatrix} &&y(2) \begin{pmatrix} 1 & 1 \end{pmatrix}\begin{pmatrix} 0 \\ 1 \end{pmatrix} = 1 \\
		&S(3) = \begin{pmatrix} 0 & 1 \\ 1 & 0 \end{pmatrix}S(2) + \begin{pmatrix} 1 \\ 0 \end{pmatrix}x(2) = \begin{pmatrix} 1 \\ 0 \end{pmatrix} &&y(3) \begin{pmatrix} 1 & 1 \end{pmatrix}\begin{pmatrix} 1 \\ 0 \end{pmatrix} = 1 \\
	\end{align*}
\end{solution}
